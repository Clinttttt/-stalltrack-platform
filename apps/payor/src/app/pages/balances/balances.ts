      ...
      <main class="flex-1 px-5 pb-8">
        ...
        @if (loading()) {
          ...
          @for (item of items(); track key(item)) {
            <article class="mt-3 rounded-2xl border border-line bg-white p-4 shadow-soft">
              <div class="flex items-start justify-between gap-3">
                ...
                <p class="shrink-0 font-display text-base text-navy">
          ...
          <p class="mt-7 rounded-2xl border border-line bg-white p-4 text-xs leading-relaxed text-muted shadow-soft">
            Paying online is not available on this address yet. Use the link your municipal office gave you, or pay
            the collector at your stall. An Official Receipt is issued by the office once your payment is validated.
          </p>
        }
      </main>
